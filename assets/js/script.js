...
$(document).ready(function () {
  ...
  //   Present timeblocks for standard business hours (9am-6pm chosen) when the user scrolls down.
  for (let i = 9; i < 19; i++) {
    // create a row
  ...
  // add css class based on time that will color-code timeblocks based on past, present, and future
